...
class GameScene: SKScene,SKPhysicsContactDelegate{
    ...
    func setupWall() {
        ...
        scoreNode.physicsBody?.node?.name = "score"
    ...
    func setupItem(){
        ...
        item.position = CGPoint(x: self.size.width, y: self.size.height*rand)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if (contact.bodyA.categoryBitMask & scoreCategory) == scoreCategory || (contact.bodyB.categoryBitMask & scoreCategory) == scoreCategory {
            ...
            //SKAudioNode版
//            let music = SKAudioNode(fileNamed: "coin08.mp3")
...
//            self.addChild(music)
            ...
            //AVAudioPlayer版
            let audioPath = NSURL(fileURLWithPath: Bundle.main.path(forResource: "coin08", ofType: "mp3")!)
            do {
